...
class UsersRecord extends FirestoreRecord {
  ...
  // "permissions" field.
  PermissionsStruct? _permissions;
  PermissionsStruct get permissions => _permissions ?? PermissionsStruct();
  ...
  void _initializeFields() {
    ...
    _permissions = PermissionsStruct.maybeFromMap(snapshotData['permissions']);
...
Map<String, dynamic> createUsersRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'country': country,
      'permissions': PermissionsStruct().toMap(),
